...
<p align="center">
  <img src="docs/logo_circle.png" alt="GearCam" width="220">
</p>
...
- **Mic-level inputs need an attenuator** in front of anything hotter, such as a mixer, an amp output or a Eurorack case. A [3.5 mm line-to-mic attenuator cable](https://www.cubilux.com/products/3-5mm-line-level-to-microphone-level-attenuator-cable) does the job, with a dial for 0 to −15, −25 or −35 dB; set it so the loudest passage stops short of the strip's clipping indicator. Attenuating in the cable is the only fix once a signal overloads the adapter's own preamp.
