...
public class MyPreferenceFragment extends PreferenceFragment implements OnSharedPreferenceChangeListener {
            ...
            pref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
                ...
                public boolean onPreferenceClick(Preference arg0) {
                    if( pref.getKey().equals("preference_about") ) {
                        ...
                        about_string.append("GearCam — based on Open Camera (Mark Harman, GPLv3+)\nVersion ");
                        ...
                        String save_location = sharedPreferences.getString(PreferenceKeys.SaveLocationPreferenceKey, "GearCam");
                        about_string.append("\nSave Location: ");
                        ...
                        alertDialog.setNegativeButton(R.string.about_copy_to_clipboard, new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                ClipData clip = ClipData.newPlainText("GearCam About", about_string);
    ...
    static void refreshPreferenceValues(SharedPreferences prefs, PreferenceGroup group) {
        if (group == null) return;
        for (int i = 0; i < group.getPreferenceCount(); i++) {
            Preference pref = group.getPreference(i);
            if (pref.getKey() != null && prefs.contains(pref.getKey()))
                handleOnSharedPreferenceChanged(prefs, pref.getKey(), pref);
            if (pref instanceof PreferenceGroup) refreshPreferenceValues(prefs, (PreferenceGroup) pref);
        }
    }
